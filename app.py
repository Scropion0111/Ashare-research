...
def render_nav_tabs():
    """
    纯横向导航栏 - 基于 URL 查询参数路由
    使用纯 CSS + JavaScript，无需任何 st.button
    """
    # 初始化或获取当前 tab
    ...
    # 添加 JavaScript：切换 URL 查询参数并刷新页面
    js_code = '''
    <script>
    ...
    if current_tab == 0:
        ...
        if not access_key:
            ...
            <div style="text-align:center; padding:16px 0 24px;">
                <strong style="color:#f59e0b; cursor:pointer;" onclick="document.getElementById('nav_tab_2').click()">
